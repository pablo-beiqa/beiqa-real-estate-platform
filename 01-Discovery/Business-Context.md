# Contexto de Negocio - BEIQA

## Sobre Beiqa

**Industria**: Servicios inmobiliarios comerciales / Tenant Representation

**Modelo de negocio**: Comisión por transacción inmobiliaria cerrada

**Tamaño del equipo**: 6-15 personas (comercial + operaciones)

**Clientes típicos**: Empresas grandes en expansión buscando espacios comerciales/industriales
...
```
1. SOLICITUD
   └─> Cliente contacta a Beiqa con requerimiento
       (ubicación, tamaño, presupuesto, tipo, timeline)

2. BÚSQUEDA
   └─> Equipo busca propiedades que cumplan criterios
       (portales, red de contactos, brokers)

3. ANÁLISIS
   └─> Evaluación de opciones
       (precio, ubicación, condiciones, comparables)

4. PRESENTACIÓN
   └─> Shortlist de opciones al cliente
       (fichas técnicas, reportes, visitas)

5. SELECCIÓN
   └─> Cliente evalúa y selecciona
       (múltiples rondas posibles)

6. NEGOCIACIÓN
   └─> Beiqa negocia términos en nombre del cliente
       (precio, condiciones, mejoras)
...
4. Mejor experiencia del cliente (portal dedicado)
